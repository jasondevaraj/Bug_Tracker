"""
Intelligent Software Defect Tracking System with Resolution Assistance - Main Application Entry Point
...
st.markdown("""
    <div style="text-align: center; padding: 3rem 1rem;">
        ...
        <p style="font-size: 1.2rem; color: #94A3B8; margin-top: 1rem;">
            Welcome to the Intelligent Software Defect Tracking System with Resolution Assistance
        </p>
